    ...
    <section className="glass gallery">
      <div className="gallery-head">
        <div>
          ...
          <p>
            {sale.reveal
              ? "نمایش آخرین کارت‌های مینت‌شده کل مجموعه (همه کیف‌پول‌ها) — نه فقط NFTهای شما."
              : "قبل از Reveal فقط تصویر مخفی نشان داده می‌شود. این بخش کل مجموعه است، نه کیف شما."}
          </p>
        </div>
